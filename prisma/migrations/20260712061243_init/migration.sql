...
-- CreateEnum
CREATE TYPE "DiscrepancyResolution" AS ENUM ('OPEN', 'RESOLVED');
...
-- CreateEnum
CREATE TYPE "MediaCategory" AS ENUM ('PHOTO', 'DOCUMENT');

-- CreateEnum
CREATE TYPE "MediaEntityType" AS ENUM ('ASSET', 'MAINTENANCE_REQUEST', 'AUDIT_ITEM', 'ALLOCATION', 'USER');
...
CREATE TABLE "Media" (
    ...
    "category" "MediaCategory" NOT NULL DEFAULT 'PHOTO',
...
CREATE TABLE "AuditItem" (
    ...
    "discrepancyStatus" "DiscrepancyResolution",
    "resolvedById" TEXT,
    "resolutionNotes" TEXT,
